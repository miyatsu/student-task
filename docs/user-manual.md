...
- `DOCX` 文档会直接在浏览器内读取结构并转成 PDF，整个流程保持 local-first。
...
- 当你一次选择多份 Word 文档并点击 **To PDF** 后，Word 区块底部会显示与图片转换一致的绿色进度卡片，包含环形百分比、进度条、`已完成/总数` 数字、当前文件名，以及本次任务的已用时长，方便你估算还需要等待多久。
